...
int _profileEstimateSize(
  ...
  bytesCount += 3 + object.favoriteGame.length * 3;
...
void _profileSerialize(
  ...
  writer.writeString(offsets[0], object.favoriteGame);
...
Profile _profileDeserialize(
  ...
  final object = Profile(
    favoriteGame: reader.readString(offsets[0]),
...
extension ProfileQueryFilter
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'favoriteGame',
        value: value,
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteGameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'favoriteGame',
        value: '',
...
extension ProfileQuerySortBy on QueryBuilder<Profile, Profile, QSortBy> {
  QueryBuilder<Profile, Profile, QAfterSortBy> sortByFavoriteGame() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteGame', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> sortByFavoriteGameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteGame', Sort.desc);
    });
  }
...
extension ProfileQuerySortThenBy
  ...
  QueryBuilder<Profile, Profile, QAfterSortBy> thenByFavoriteGame() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteGame', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> thenByFavoriteGameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteGame', Sort.desc);
    });
  }
...
extension ProfileQueryWhereDistinct
  ...
  QueryBuilder<Profile, Profile, QDistinct> distinctByFavoriteGame(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'favoriteGame', caseSensitive: caseSensitive);
    });
  }
...
extension ProfileQueryProperty
  ...
  QueryBuilder<Profile, String, QQueryOperations> favoriteGameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'favoriteGame');
    });
  }
